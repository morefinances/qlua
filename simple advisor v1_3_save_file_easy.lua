...
function main() 
	...
	filename = string.sub(progname, 1, 14).." "..os.date('%d%m%Y_%H%M%S') -- наименование файла: название скрипта дата и время
	...
	my_csv:write(progname.." starttime = "..starttime..";\n")
	message(progname.." nomorningtime = "..nomorningtime)
	my_csv:write(progname.." nomorningtime = "..nomorningtime..";\n")
	message(progname.." nonewsignalstime = "..nonewsignalstime)
	my_csv:write(progname.." nonewsignalstime = "..nonewsignalstime..";\n")
	message(progname.." finishtime = "..finishtime)
	my_csv:write(progname.." finishtime = "..finishtime..";\n")
	...
	while hhmmss(os.sysdate()) < starttime do
		...
		my_csv:write('Ожидаем время старта скрипта : '..starttime..", текущее время: "..time1..";\n")
		sleep(timeout2)
	end
	...
	while do_it do
		...
		if time2>= finishtime then
			...
			message(progname..table_text)
			my_csv:write(progname..table_text..";\n")
			SetCell(table_result, table_result_ind, 1, table_text)
			OnStop()
		end
